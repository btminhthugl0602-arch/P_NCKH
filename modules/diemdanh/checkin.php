        ...
        <div class="container d-lg-flex justify-content-between align-items-center">
            ...
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li><a
                            href="<?= _HOST_URL ?>/?module=event&action=view&id=<?= $phien['idSK'] ?>"><?= htmlspecialchars($phien['tenSK']) ?></a>
                    </li>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 col-md-8">
                    ...
                    <div class="enrollment-form-wrapper text-center" data-aos="zoom-in">
                        ...
                        <div class="course-details-card mb-4 text-start">
                            <div class="detail-grid">
                                <div class="detail-row">
                                    ...
                                    <span
                                        class="detail-value fw-semibold"><?= htmlspecialchars($userInfo['tenHienThi'] ?? '') ?></span>
                                </div>
                                ...
                                <?php endif; ?>
                                <div class="detail-row">
                                    <span class="detail-label">Phiên</span>
                                    <span class="detail-value"><?= htmlspecialchars($phien['tenPhien']) ?></span>
                                </div>
                                <div class="detail-row">
                        ...
                        <a href="<?= _HOST_URL ?>/?module=event&action=view&id=<?= $phien['idSK'] ?>"
                    ...
                    <div class="enrollment-form-wrapper text-center" data-aos="zoom-in">
                        ...
                        <div class="mb-4">
                            <div class="d-inline-flex align-items-center justify-content-center rounded-circle"
                                ...
                                <i class="bi bi-lock"
                                    style="font-size:2.5rem;color:color-mix(in srgb,var(--default-color),transparent 40%)"></i>
                            </div>
                        </div>
                        ...
                        <div class="enrollment-header mb-4">
                            ...
                            <p>
                                <?php if (!$moTime): ?>
                                Ban tổ chức chưa mở điểm danh cho phiên này.
                                <?php else: ?>
                        ...
                        <div class="course-details-card mb-4 text-start">
                            <div class="detail-grid">
                                ...
                                <div class="detail-row">
                                    ...
                                    <span class="detail-value"><?= htmlspecialchars($phien['tenSK']) ?></span>
                                </div>
                                <?php if ($phien['thoiGianBatDau']): ?>
                                <div class="detail-row">
                                    <span class="detail-label">Thời gian</span>
                                    <span
                                        class="detail-value"><?= date('H:i, d/m/Y', strtotime($phien['thoiGianBatDau'])) ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="enrollment-form-wrapper" data-aos="zoom-in">
                        ...
                        <div class="enrollment-header text-center mb-0">
                            ...
                            <p>
                                <strong><?= htmlspecialchars($phien['tenPhien']) ?></strong>
                                <span class="text-muted"> — </span><?= htmlspecialchars($phien['tenSK']) ?>
                            </p>
                        </div>
                        ...
                        <form method="post" action="?module=diemdanh&action=checkin&lich=<?= $id_phien ?>"
                            ...
                            <div class="course-details-card mb-4">
                                <h4 style="font-size:1rem"><i class="bi bi-person-circle me-2"
                                        style="color:var(--accent-color)"></i>Thông tin của bạn</h4>
                                <div class="detail-grid">
                                    <div class="detail-row">
                                        <span class="detail-label">Họ tên</span>
                                        <span
                                    ...
                                    <?php endif; ?>
                                    <?php if ($phien['viTriLat'] && $phien['viTriLng']): ?>
                                    <div class="detail-row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="token" id="inputToken" class="form-control text-center fw-bold"
                                    style="font-size:2.4rem;letter-spacing:.7em;padding:14px 8px" maxlength="6"
                                    inputmode="numeric" pattern="[0-9]{6}" placeholder="——————" autocomplete="off"
                                    required value="<?= htmlspecialchars($_POST['token'] ?? '') ?>">
                            ...
                            <p class="enrollment-note text-center mt-3">
                                ...
                                Mỗi người chỉ điểm danh được 1 lần cho mỗi phiên
                            </p>
                        </form>
...
function gpsOK(lat, lng, acc) {
    ...
    if (gpsRow) gpsRow.innerHTML = '<span class="badge bg-success"><i class="bi bi-geo-alt-fill me-1"></i>±' + Math
        .round(acc) + 'm</span>';
}

function gpsErr(msg) {
    if (gpsRow) gpsRow.innerHTML = '<span class="badge bg-danger"><i class="bi bi-x-circle me-1"></i>' + msg +
    '</span>';
}
