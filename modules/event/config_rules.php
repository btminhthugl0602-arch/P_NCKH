                ...
                <div class="card shadow-sm border-0 mb-4 h-100">
                    ...
                    <div class="card-body bg-light">
                        <div class="mb-2">
                            ...
                            <span id="errAddCondition" class="text-danger small d-none mb-2 d-block"></span>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <div>
                                    ...
                                    <form method="post" class="d-inline" id="formXoaQuyChe-<?php echo $qc['idQuyChe']; ?>">
                                        <input type="hidden" name="action" value="delete_rule">
                                        <input type="hidden" name="id_delete" value="<?php echo $qc['idQuyChe']; ?>">
                                        <button type="button" class="btn btn-sm btn-danger"
                                                onclick="showConfirm({
                                                    title: 'Xác nhận xóa Quy chế',
                                                    message: 'Thao tác không thể hoàn tác.',
                                                    type: 'danger',
                                                    confirmText: 'Xóa',
                                                    onConfirm: () => document.getElementById('formXoaQuyChe-<?php echo $qc['idQuyChe']; ?>').submit()
                                                })">
...
<script>
    ...
    function addVariable() {
        ...
        if (!selTT.value || !inputVal.value.trim()) {
            const errEl = document.getElementById('errAddCondition');
            errEl.textContent = 'Vui lòng chọn Thuộc tính và nhập Giá trị!';
            errEl.classList.remove('d-none');
            return;
        }
        document.getElementById('errAddCondition')?.classList.add('d-none');
        ...
        document.getElementById('emptyVarMsg').classList.add('d-none');
