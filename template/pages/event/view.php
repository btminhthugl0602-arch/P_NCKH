                                ...
                                <div class="mt-4">
                                    ...
                                    <div
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">Phiên:
                                                <?= htmlspecialchars($phien_dang_mo['tenPhien']) ?></small>
                                            <?php else: ?>
                                            <strong class="d-block">Đang có phiên điểm danh mở!</strong>
                                            <small>
                                                <?= htmlspecialchars($phien_dang_mo['tenPhien']) ?>
                                                &nbsp;—&nbsp; Đóng lúc
                                                <?= date('H:i', strtotime($phien_dang_mo['thoiGianDong'])) ?>
                                            </small>
                                            <?php endif; ?>
                                        </div>
                                        <?php if (!$da_diemdanh): ?>
                                        <a href="<?= _HOST_URL ?>/?module=diemdanh&action=checkin&lich=<?= (int)$phien_dang_mo['idPhienDD'] ?>"
                                        ...
                                        <div class="row g-2">
                                            <div class="col-12">
                                                <a class="btn btn-outline-secondary w-100 py-3 fw-bold"
                                                    ...
                                                    <i class="bi bi-people-fill d-block fs-3 mb-1"></i> Quản lý thành
                                                    viên sự kiện
                                                </a>
                                            </div>
                                        </div>
